...
TRAINING_ARGS1="--minibatch_size 32 --num_epochs 300 --clip_grad 0.5"
TRAINING_ARGS2="--lr 0.00001 --max_lr 0.001 --reg_lambda 0.00001"
MODEL_ARGS="--hidden_dims 58 100 200 --sparsities 0 0 0 --dropout 0.2"
